...
<html:form action="/altajugador" onsubmit="return fParams( )">

<table  cellspacing="2" cellpadding="1" border="1" width="100%">
<tr>
    <td><bean:message key="jugid.prompt"/></td>
    <td><html:text property="jugid" onkeypress="EvaluateText('%d', this)" /></td>
</tr>
<tr>
...
<tr>
    ...
    <td><html:text property="jugedad" onkeypress="EvaluateText('%d', this)" /></td>
</tr>
<tr>
